...
Public Class Selectfood3
    ...
    Private Sub PictureBox26_Click(sender As Object, e As EventArgs)
        ...
        table3 = "null"
        rebugtable3 = 0
        Clear_DG(DataGridView3)
        TextBox1.Text = ""
        TextBox10.Text = ""
        TextBox11.Text = ""


        MessageBox.Show("** ปิดบิลโต๊ะ 3 เรียบร้อยแล้ว ** " & vbNewLine & "*** กำลังกลับสู่หน้าหลัก ***", "การแจ้งเตือนจากระบบ",
    ...
    Private Sub PD_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PD.PrintPage
        ...
        'เวลา
        e.Graphics.DrawString("เวลา", f8, Brushes.Black, 0, 75)
        e.Graphics.DrawString(" : ", f8, Brushes.Black, 50, 75)
        e.Graphics.DrawString(lbltime.Text, f8, Brushes.Black, 70, 75)
        'โต๊ะ
        e.Graphics.DrawString("โต๊ะที่ 3 ", f10, Brushes.Black, 208, 75)
        'วันที่
        e.Graphics.DrawString("วันที่", f8, Brushes.Black, 0, 90)
        e.Graphics.DrawString(" : ", f8, Brushes.Black, 50, 90)
        e.Graphics.DrawString(lbldate.Text, f8, Brushes.Black, 70, 90)
        e.Graphics.DrawString("ราคารวม", f8, Brushes.Black, 208, 90)
        e.Graphics.DrawString("จำนวน", f8, Brushes.Black, 163, 90)
        'เส้นขั่น
        ...
        For row As Integer = 0 To DataGridView3.RowCount - 1
            height += 15
            'ชื่อเมนู
            e.Graphics.DrawString(DataGridView3.Rows(row).Cells(1).Value.ToString, f10, Brushes.Black, 0, 100 + height)
            'จำนวน
            e.Graphics.DrawString(DataGridView3.Rows(row).Cells(3).Value.ToString, f10, Brushes.Black, 177, 100 + height)
            'ราคารวม
            i = DataGridView3.Rows(row).Cells(2).Value
            DataGridView3.Rows(row).Cells(2).Value = Format(i, "##,##0")
            e.Graphics.DrawString(DataGridView3.Rows(row).Cells(2).Value.ToString, f10, Brushes.Black, rightmargin, 100 + height, right)
        Next
        ...
        e.Graphics.DrawString(ssum3, f10b, Brushes.Black, rightmargin, 10 + height2, right)
        ...
        averagepeople3 = ssum3 / people3
        e.Graphics.DrawString(averagepeople3, f10b, Brushes.Black, rightmargin, 70 + height2, right)

        e.Graphics.DrawString("~ ขอบคุณที่ใช้บริการ ~", f10, Brushes.Black, centermargin, 90 + height2, center)
        e.Graphics.DrawString("~ ร้านอาหารไทย & อิตาเลียน ~", f10, Brushes.Black, centermargin, 110 + height2, center)
        e.Graphics.DrawString("~ By ~", f10, Brushes.Black, centermargin, 130 + height2, center)
        e.Graphics.DrawString("~ ธาดาพงศ์ สุทธิกิจรุ่งโรจน์ ~", f10, Brushes.Black, centermargin, 150 + height2, center)
    ...
    Private Sub CheckBox2_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox2.CheckedChanged
        ...
        If CheckBox2.Checked = True Then
            Me.DataGridView3.Rows.Add("อาหารไทย", "ต้มยำกุ้ง", "250", food2, price2)
        ...
        ssum3 = 0
        For i As Integer = 0 To DataGridView3.Rows.Count() - 1 Step +1
            ssum3 += DataGridView3.Rows(i).Cells(4).Value
        Next
        TextBox1.Text = ssum3
    End Sub
    ...
    Private Sub CheckBox3_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox3.CheckedChanged
        ...
        If CheckBox3.Checked = True Then
            Me.DataGridView3.Rows.Add("อาหารไทย", "ส้มตำ", "90", food3, price3)
    ...
    Private Sub CheckBox1_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox1.CheckedChanged
        ...
        If CheckBox1.Checked = True Then
            Me.DataGridView3.Rows.Add("อาหารไทย", "ผัดไทย", "100", food1, price1)
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        If DataGridView3.Rows.Count >= 1 Then
            If DataGridView3.CurrentRow.Cells(0).Value <> "" Then
                If MessageBox.Show("** คุณต้องการลบรายการอาการ " & DataGridView3.CurrentRow.Cells(1).Value & " จำนวน " &
                                   DataGridView3.CurrentRow.Cells(3).Value & " รายการใช้หรือไม่", "การแจ้งเตือนจากระบบ",
    ...
    Private Sub CheckBox4_CheckedChanged(sender As Object, e As EventArgs)
        ...
        If CheckBox4.Checked = True Then
            Me.DataGridView3.Rows.Add("อาหารอิตาเลียน", "พิซซ่า", "199", itaian1food1, priceitaian1)
    ...
    Private Sub CheckBox5_CheckedChanged_1(sender As Object, e As EventArgs) Handles CheckBox5.CheckedChanged
        ...
        If CheckBox5.Checked = True Then
            Me.DataGridView3.Rows.Add("อาหารอิตาเลียน", "ลาซานญ่า", "259", itaian1food2, priceitaian2)
    ...
    Private Sub NumericUpDown6_ValueChanged(sender As Object, e As EventArgs)
    ...
    Private Sub CheckBox6_CheckedChanged(sender As Object, e As EventArgs)
        ...
        If CheckBox6.Checked = True Then
            Me.DataGridView3.Rows.Add("อาหารอิตาเลียน", "พาสต้า", "149", itaian1food3, priceitaian3)
    ...
    Private Sub CheckBox7_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox7.CheckedChanged
        ...
        If CheckBox7.Checked = True Then
            Me.DataGridView3.Rows.Add("อาหารอิตาเลียน", "ริซอตโต้", "219", itaian1food4, priceitaian4)
    ...
    Private Sub CheckBox8_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox8.CheckedChanged
        ...
        If CheckBox8.Checked = True Then
            Me.DataGridView3.Rows.Add("น้ำ", "น้ำอัดลม", "20", water1, pricewater1)
    ...
    Private Sub CheckBox9_CheckedChanged(sender As Object, e As EventArgs)
        ...
        If CheckBox9.Checked = True Then
            Me.DataGridView3.Rows.Add("น้ำ", "น้ำเปล่า", "15", water2, pricewater2)
    ...
    Private Sub CheckBox10_CheckedChanged(sender As Object, e As EventArgs)
        ...
        If CheckBox10.Checked = True Then
            Me.DataGridView3.Rows.Add("ขนมหวาน", "ข้าวเหนียวมะม่วง", "119", sugar1, pricesugar1)
    ...
    Private Sub CheckBox11_CheckedChanged_1(sender As Object, e As EventArgs) Handles CheckBox11.CheckedChanged
        ...
        If CheckBox11.Checked = True Then
            Me.DataGridView3.Rows.Add("ขนมหวาน", "เจลาโต", "109", sugar2, pricesugar2)
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs)
        If ssum3 > TextBox10.Text Then
            MessageBox.Show("** ยอดเงินไม่เพียงพอ ไม่สามารถชำระเงินได้ ** " & vbNewLine & "*** กรุณาใส่จำนวนเงินใหม่อีกครั้ง ***", "การแจ้งเตือนจากระบบ",
                                      MessageBoxButtons.OK, MessageBoxIcon.Error)
            TextBox10.Text = ""
        Else

            If DataGridView3.Rows.Count > 1 Or DataGridView3.Rows.Count = 1 Then
    ...
    Private Sub TextBox10_TextChanged(sender As Object, e As EventArgs)
        If ssum3 > Val(TextBox10.Text) Then
            Button6.Enabled = False
        Else
    ...
    Private Sub PictureBox26_Click_1(sender As Object, e As EventArgs) Handles PictureBox26.Click
        ...
        Me.Hide()
        '**********************************************************************************
        Sales.DataGridView1.Rows.Add(User, people3, Label33.Text, namereverse3, ssum3)
        '**********************************************************************************
        namereverse3 = ""
        people3 = 0
    End Sub
    ...
    Private Sub CheckBox6_CheckedChanged_1(sender As Object, e As EventArgs) Handles CheckBox6.CheckedChanged
        Dim priceitaian5 As Integer
        Dim itaian1food5 As Integer = NumericUpDown6.Value
        priceitaian5 = itaian1food5 * 149
        If CheckBox6.Checked = True Then
            Me.DataGridView3.Rows.Add("อาหารอิตาเลียน", "พาสต้า", "149", itaian1food5, priceitaian5)
            CheckBox6.Checked = False
        Else
            NumericUpDown6.Value = False
            CheckBox6.Enabled = False
    ...
    Private Sub CheckBox4_CheckedChanged_1(sender As Object, e As EventArgs) Handles CheckBox4.CheckedChanged
        Dim priceitaian3 As Integer
        Dim itaian1food3 As Integer = NumericUpDown4.Value
        priceitaian3 = itaian1food3 * 199
        If CheckBox4.Checked = True Then
            Me.DataGridView3.Rows.Add("อาหารอิตาเลียน", "พิซซ่า", "199", itaian1food3, priceitaian3)
            CheckBox4.Checked = False
        Else
            NumericUpDown4.Value = False
            CheckBox4.Enabled = False
    ...
    Private Sub NumericUpDown10_ValueChanged_1(sender As Object, e As EventArgs) Handles NumericUpDown10.ValueChanged
        CheckBox10.Enabled = True
    End Sub
