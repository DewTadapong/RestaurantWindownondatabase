...
Public Class Selectfoodhome
    ...
    Private Sub PictureBox26_Click(sender As Object, e As EventArgs) Handles PictureBox26.Click
        ...
        MessageBox.Show("** ขอบคุณที่สั่งอาหารกลับบ้าน ** " & vbNewLine & "*** กำลังกลับสู่หน้าหลัก ***", "การแจ้งเตือนจากระบบ",
                                   MessageBoxButtons.OK, MessageBoxIcon.Asterisk)

        '**********************************************************************************
        Sales.DataGridView1.Rows.Add(User, people4, Label33.Text, namereverse4, ssum4)
        '**********************************************************************************
        namereverse4 = ""
        Home.Show()
        Me.Hide()
    ...
    Private Sub PD_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PD.PrintPage
        ...
        'โต๊ะ
        e.Graphics.DrawString("สั่งกลับบ้าน ", f10, Brushes.Black, 208, 75)
        ...
        e.Graphics.DrawString(ssum4, f10b, Brushes.Black, rightmargin, 10 + height2, right)
        ...
        '  averagepeople4 = ssum4 / people4
        'e.Graphics.DrawString(averagepeople4, f10b, Brushes.Black, rightmargin, 70 + height2, right)
    ...
    Private Sub PictureBox9_Click(sender As Object, e As EventArgs) Handles PictureBox9.Click
        ...
        If DataGridView1.Rows.Count > 1 Then
            ...
            Me.Hide()
        Else
            MessageBox.Show("  ** กรุณาเพิ่มสินค้าก่อนไปหน้าอื่น **" & vbNewLine & "         *** หรือทำการยกเลิกบิลนี้ก่อนครับ ***",
    ...
    Private Sub CheckBox2_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox2.CheckedChanged
        ...
        For i As Integer = 0 To DataGridView1.Rows.Count() - 1 Step +1
            ssum4 += DataGridView1.Rows(i).Cells(4).Value
        Next
        TextBox1.Text = ssum4
    End Sub
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        If DataGridView1.Rows.Count > 1 Then
            ...
            Me.Hide()
        Else
            MessageBox.Show("  ** คุณเปิดบิลแล้ว กรุณาเพิ่มสินค้าก่อนไปหน้าอื่น **" & vbNewLine & "         *** หรือทำการยกเลิกบิลนี้ก่อนครับ ***",
                            "การแจ้งเตือนจากระบบ", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        End If
    End Sub
