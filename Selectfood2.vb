...
Public Class Selectfood2
    ...
    Private Sub PictureBox26_Click(sender As Object, e As EventArgs)
        ...
        table2 = "null"
        rebugtable1 = 0
        Clear_DG(DataGridView2)
        TextBox1.Text = ""
        TextBox10.Text = ""
        TextBox11.Text = ""


        MessageBox.Show("** ปิดบิลโต๊ะ 2 เรียบร้อยแล้ว ** " & vbNewLine & "*** กำลังกลับสู่หน้าหลัก ***", "การแจ้งเตือนจากระบบ",
    ...
    Private Sub PD_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PD.PrintPage
        ...
        'โต๊ะ
        e.Graphics.DrawString("โต๊ะที่ 2 ", f10, Brushes.Black, 208, 75)
        'วันที่
        ...
        For row As Integer = 0 To DataGridView2.RowCount - 1
            ...
            'จำนวน
            e.Graphics.DrawString(DataGridView2.Rows(row).Cells(3).Value.ToString, f10, Brushes.Black, 177, 100 + height)
            'ราคารวม
        ...
        e.Graphics.DrawString(ssum2, f10b, Brushes.Black, rightmargin, 10 + height2, right)
        ...
        averagepeople2 = ssum2 / people2
        e.Graphics.DrawString(averagepeople2, f10b, Brushes.Black, rightmargin, 70 + height2, right)
    ...
    Private Sub CheckBox2_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox2.CheckedChanged
        ...
        If CheckBox2.Checked = True Then
            Me.DataGridView2.Rows.Add("อาหารไทย", "ต้มยำกุ้ง", "250", food2, price2)
        ...
        For i As Integer = 0 To DataGridView2.Rows.Count() - 1 Step +1
            ssum2 += DataGridView2.Rows(i).Cells(4).Value
        Next
        TextBox1.Text = ssum2
    End Sub
    ...
    Private Sub CheckBox3_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox3.CheckedChanged
        ...
        If CheckBox3.Checked = True Then
            Me.DataGridView2.Rows.Add("อาหารไทย", "ส้มตำ", "90", food3, price3)
    ...
    Private Sub CheckBox1_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox1.CheckedChanged
        ...
        If CheckBox1.Checked = True Then
            Me.DataGridView2.Rows.Add("อาหารไทย", "ผัดไทย", "100", food1, price1)
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        If DataGridView2.Rows.Count > 1 Then
            If DataGridView2.CurrentRow.Cells(0).Value <> "" Then
                If MessageBox.Show("** คุณต้องการลบรายการอาการ " & DataGridView2.CurrentRow.Cells(1).Value & " จำนวน " &
                                   DataGridView2.CurrentRow.Cells(3).Value & " รายการใช้หรือไม่", "การแจ้งเตือนจากระบบ",
    ...
    Private Sub CheckBox4_CheckedChanged(sender As Object, e As EventArgs) 
        ...
        If CheckBox4.Checked = True Then
            Me.DataGridView2.Rows.Add("อาหารอิตาเลียน", "พิซซ่า", "199", itaian1food1, priceitaian1)
    ...
    Private Sub CheckBox5_CheckedChanged_1(sender As Object, e As EventArgs) Handles CheckBox5.CheckedChanged
        ...
        If CheckBox5.Checked = True Then
            Me.DataGridView2.Rows.Add("อาหารอิตาเลียน", "ลาซานญ่า", "259", itaian1food2, priceitaian2)
    ...
    Private Sub CheckBox6_CheckedChanged(sender As Object, e As EventArgs) 
        ...
        If CheckBox6.Checked = True Then
            Me.DataGridView2.Rows.Add("อาหารอิตาเลียน", "พาสต้า", "149", itaian1food3, priceitaian3)
    ...
    Private Sub CheckBox7_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox7.CheckedChanged
        ...
        If CheckBox7.Checked = True Then
            Me.DataGridView2.Rows.Add("อาหารอิตาเลียน", "ริซอตโต้", "219", itaian1food4, priceitaian4)
    ...
    Private Sub NumericUpDown9_ValueChanged(sender As Object, e As EventArgs) 
    ...
    Private Sub CheckBox8_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox8.CheckedChanged
        ...
        If CheckBox8.Checked = True Then
            Me.DataGridView2.Rows.Add("น้ำ", "น้ำอัดลม", "20", water1, pricewater1)
    ...
    Private Sub CheckBox9_CheckedChanged(sender As Object, e As EventArgs) 
        ...
        If CheckBox9.Checked = True Then
            Me.DataGridView2.Rows.Add("น้ำ", "น้ำเปล่า", "15", water2, pricewater2)
    ...
    Private Sub CheckBox10_CheckedChanged(sender As Object, e As EventArgs) 
        ...
        If CheckBox10.Checked = True Then
            Me.DataGridView2.Rows.Add("ขนมหวาน", "ข้าวเหนียวมะม่วง", "119", sugar1, pricesugar1)
    ...
    Private Sub CheckBox11_CheckedChanged_1(sender As Object, e As EventArgs) Handles CheckBox11.CheckedChanged
        ...
        If CheckBox11.Checked = True Then
            Me.DataGridView2.Rows.Add("ขนมหวาน", "เจลาโต", "109", sugar2, pricesugar2)
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs)
        ...
        Else
            ...
            If DataGridView2.Rows.Count > 1 Or DataGridView2.Rows.Count = 1 Then
    ...
    Private Sub TextBox10_TextChanged(sender As Object, e As EventArgs)
        If ssum2 > Val(TextBox10.Text) Then
            Button6.Enabled = False
        Else
    ...
    Private Sub PictureBox26_Click_1(sender As Object, e As EventArgs) Handles PictureBox26.Click
        ...
        Me.Hide()
        '**********************************************************************************
        Sales.DataGridView1.Rows.Add(User, people2, Label33.Text, namereverse2, ssum2)
        '**********************************************************************************
        namereverse2 = ""
        people2 = 0
    End Sub
    ...
    Private Sub CheckBox6_CheckedChanged_1(sender As Object, e As EventArgs) Handles CheckBox6.CheckedChanged
        ...
        ssum3 = 0
        For i As Integer = 0 To DataGridView2.Rows.Count() - 1 Step +1
            ssum3 += DataGridView2.Rows(i).Cells(4).Value
        Next
        TextBox1.Text = ssum3
    End Sub
    ...
    Private Sub NumericUpDown9_ValueChanged_1(sender As Object, e As EventArgs) Handles NumericUpDown9.ValueChanged
        CheckBox9.Enabled = True
    End Sub
